...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($id_barang) {
            ...
            $sql = "INSERT INTO kendaraan (nama_barang, merk, no_seri, ukuran, bahan, pembelian, kode_barang, jumlah_barang, keadaan_barang, keterangan_barang) 
    ...
    if (isset($_GET['id_barang'])) {
        ...
        $sql = "DELETE FROM kendaraan WHERE id_barang='$id_barang'";
        if (mysqli_query($kon, $sql)) {
            header("Location: kendaraan.php");
            exit();
        } else {
    ...
    <div class="table-container">
        <table id="dataTable" class="table table-bordered my-3">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM kendaraan ORDER BY id_barang ASC";
    ...
    <a id="backButton" href="gedung.html">Kembali</a>
</div>
